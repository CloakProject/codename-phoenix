...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-maxorphanblocks=<n>", strprintf("Keep at most <n> unconnectable blocks in memory (default: %d)", DEFAULT_MAX_ORPHAN_BLOCKS), false, OptionsCategory::OPTIONS);
