...
CBlock TestChain100Setup::CreateAndProcessBlock(const std::vector<CMutableTransaction>& txns, const CScript& scriptPubKey)
{
    ...
    CBlock block = BlockAssembler(empty_pool, chainparams).CreateNewBlock(scriptPubKey, false)->block;
    ...
    Assert(m_node.chainman)->ProcessNewBlock(chainparams, shared_pblock, true, shared_pblock->IsProofOfStake(), nullptr);
