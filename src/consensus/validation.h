...
enum class BlockValidationResult {
    ...
    BLOCK_TIME_PAST,         //!< block coinbase timestamp is too early (or our clock is bad)
    BLOCK_CHECKPOINT,        //!< the block failed to meet one of our checkpoints
    BLOCK_POW_CUTOFF,        //!< proof-of-work not allowed anymore
    BLOCK_INVALID_WORK,      //!< incorrect proof-of-work/stake at current height
};
